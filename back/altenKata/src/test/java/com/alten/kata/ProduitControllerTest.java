...
import com.alten.kata.controller.ProduitController;
...
import static org.mockito.Mockito.*;
 class ProduitControllerTest {
    ...
    void shouldGetOneProduct() {
        mockUser("mm@mm.com");
        when(productService.getProductWithId(1L)).thenReturn(Optional.ofNullable(product));
    ...
    void shouldUpdateProduct() {
        mockUser("admin@admin.com");
        when(productService.updateProduct(1L,product2)).thenReturn(Optional.ofNullable(product2));
        ...
        verify(productService, times(1)).updateProduct(1L,product2);
    }
    @Test
    void shouldUpdateProductNotFound() {
        mockUser("admin@admin.com");
        when(productService.updateProduct(3L,product2)).thenReturn(Optional.empty());
        ...
        verify(productService, times(1)).updateProduct(3L,product2);
    }
    @Test
    ...
    void shouldDeleteProduct() {
        mockUser("admin@admin.com");
        when(productService.deleteProductWithId(1L)).thenReturn(Boolean.TRUE);
        ...
        verify(productService, times(1)).deleteProductWithId(1L);
    }
    @Test
    void shouldUpdateDeleteNotFound() {
        mockUser("admin@admin.com");
        when(productService.deleteProductWithId(3L)).thenReturn(Boolean.FALSE);
        ...
        verify(productService, times(1)).deleteProductWithId(3L);
    }
    @Test
